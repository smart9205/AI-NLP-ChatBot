...
def arguments(argsval):
    ...
    parser.add_argument('-un', '--user_name', type=str, required=False, default="smart9205",
                        help="""Overrides user.name git config.
                        If not specified, the global config is used.""")
    parser.add_argument('-ue', '--user_email', type=str, required=False, default="oranvitaliano@gmail.com",
                        help="""Overrides user.email git config.
                        If not specified, the global config is used.""")
    parser.add_argument('-da', '--days_ago', type=int, required=False, default=90,
